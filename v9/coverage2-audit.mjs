...
try{
  ...
  await page.waitForFunction(()=>!!window.AITUTOR_V9?.Lazy119);
  await page.evaluate(()=>window.AITUTOR_V9.Lazy119.ensureQuestions());
  await page.waitForFunction(()=>window.AITUTOR_V9?.Lazy119?.questionsReady===true&&!!window.AITUTOR_V9?.CoverageMap119&&!!window.AITUTOR_V9?.QuestionQuality119);
