...
ok(['F-FIRE-08','F-EXP-03'].every(id=>fullCoverage.rows.find(x=>x.id===id)?.status==='partial'),'BLEVE/pool/jet-fire and VCE/explosion-protection rows remain fail-closed');
