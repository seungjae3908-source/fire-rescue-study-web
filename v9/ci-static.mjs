...
ok(appSource.includes('tutorScrollSnapshot')&&appSource.includes('restoreTutorScroll')&&appSource.includes("state().studyTab==='ai'"),'AI study chat restores the latest conversation while retaining intentional history scroll state across AI-tab renders');
...
ok(appSource.includes('visibleTutorChat')&&appSource.includes('runtime.tutorForceLatest=true')&&appSource.includes('snap.pinned')&&appSource.includes('requestAnimationFrame(()=>requestAnimationFrame'),'AI study chat double-frames the visible conversation, pins explicit sends/latest state, and preserves intentional past-message reading');
