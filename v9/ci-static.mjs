...
ok(sourcePdf.includes('preferProxy')&&sourcePdf.includes("official-proxy-range")&&sourcePdf.includes("official-proxy-full-cache-fallback")&&sourcePdf.includes("catalog?.transport==='range-proxy'")&&sourcePdf.includes('rangeChunkSize:65536'),'official PDF viewer uses range loading for both static mirrors and the allowlisted official proxy, with full-cache only as fallback');
