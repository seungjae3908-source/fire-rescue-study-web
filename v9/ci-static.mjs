...
const phaseACombustionRows=['F-COMB-03','F-COMB-04','F-COMB-05','F-COMB-06'];
...
ok(V.FireTerminologyQuestions119?.added===11,'eleven exact-page fire terminology practice questions are loaded');
const phaseAFireTermIds=['119-fireterm-01','119-fireterm-02','119-fireterm-03','119-fireterm-04','119-fireterm-05','119-fireterm-06','119-fireterm-07','119-fireterm-08','119-fireterm-09','119-fireterm-10','119-fireterm-11'];
...
ok(fullCoverage.rows.find(x=>x.id==='F-COMB-07')?.status==='partial','combustion-products and smoke-toxicity row stays partial until direct HCN combustion-product evidence closes');
