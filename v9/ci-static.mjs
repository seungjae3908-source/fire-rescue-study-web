...
ok(appSource.includes('scrollTutorToBottom')&&appSource.includes("state().studyTab==='ai'"),'AI study chat restores the latest conversation after every AI-tab render');
...
ok(appSource.includes('scrollTutorToBottom')&&appSource.includes("document.querySelectorAll('.study-ai-chat')")&&appSource.includes('requestAnimationFrame(()=>requestAnimationFrame'),'AI study chat double-frames the visible desktop/mobile conversation to the newest answer after DOM replacement');
