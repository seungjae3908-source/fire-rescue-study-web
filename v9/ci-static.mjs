...
ok(appSource.includes("state().studyTab==='ai'")&&appSource.includes('runtime.tutorForceLatest')&&appSource.includes('x.scrollHeight-x.clientHeight-x.scrollTop<25'),'AI study chat restores latest content while retaining intentional history scroll state across AI-tab renders');
