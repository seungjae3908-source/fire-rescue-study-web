...
ok(v29Promoted.length===21&&v29Promoted.every(q=>q?.grade==='B'&&q.generatedPractice===false&&q.pageVerified===true&&q.reviewStatus==='source-reviewed'&&q.pastExamClaim!==true),'V38 keeps exactly twenty-one manually source-reviewed promoted questions as B-grade evidence');
ok(V.V29ReviewedPromotions119?.version==='119-v38-reviewed-promotions-v3'&&V.V29ReviewedPromotions119?.promoted?.length===21&&V.V29ReviewedPromotions119?.factoryPromoted===19&&V.V29ReviewedPromotions119?.exactPromoted===2,'V38 promotion registry distinguishes nineteen factory and two exact-id promotions');
