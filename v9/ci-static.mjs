...
ok(sourcePdf.includes("pdfjs-v12-anchor-context-lines")&&sourcePdf.includes('evidenceTitle:h.l.text')&&sourcePdf.includes('m.length>1||x.m.some(t=>t.length>4)'),'official PDF evidence underlines strong anchor lines plus matching explanatory context');
...
ok(appSource.includes('study-key-underline')&&appSource.includes('detailDefinitionBlock')&&appSource.includes('detailExamPointBlock')&&appSource.includes("return'종류 · 구분'")&&appSource.includes("return'작용 원리'"),'core underlines and semantic definition/type/mechanism/exam-point detail rendering are locked');
