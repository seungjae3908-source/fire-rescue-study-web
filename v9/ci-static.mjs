...
ok(['F-SCI-01','F-SCI-03','F-SCI-04','F-SCI-05','F-SCI-06'].every(id=>fullCoverage.rows.find(x=>x.id===id)?.status==='partial'),'unresolved fire-science rows remain fail-closed instead of inheriting the F-SCI-02 closure');
...
ok(V.FireTerminologyQuestions119?.added===19,'nineteen exact-page fire terminology/science practice questions are loaded');
const phaseAFireTermIds=['119-fireterm-01','119-fireterm-02','119-fireterm-03','119-fireterm-04','119-fireterm-05','119-fireterm-06','119-fireterm-07','119-fireterm-08','119-fireterm-09','119-fireterm-10','119-fireterm-11','119-fireterm-12','119-fireterm-13','119-fireterm-14','119-fireterm-15','119-fireterm-16','119-fireterm-17','119-fireterm-18','119-fireterm-19'];
