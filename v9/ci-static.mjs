...
const flameoverExam=(V.questions||[]).find(q=>q.conceptId==='F03-C10'&&q.generatedBy==='119-grounded-question-factory-v1'&&/화재현상/.test(String(q.q||'')));
ok(!!flameoverExam&&!/2026\s*소방전술1.*기준으로/.test(String(flameoverExam.q||''))&&/초기화재|대류/.test(String(flameoverExam.q||'')),'flameover generated stem is learner-facing exam prose without textbook-source framing');
ok(['플레임오버','플래시오버','롤오버','백드래프트'].every(x=>(flameoverExam?.choices||[]).includes(x)),'flameover generated identification question uses the four confusing fire phenomena as options');
const v29Promoted=['119-factory-e03-c03-detail-b','119-factory-e04-c01-detail-a','119-factory-e04-c02-detail-b','119-factory-e06-c02-detail-a','119-factory-e10-c05-detail-b','119-factory-e22-c02-detail-b','119-factory-f04-c03-detail-a','119-factory-f03-c10-detail-a','119-factory-f03-c12-detail-a','119-factory-f03-c13-detail-a','119-factory-f03-c14-detail-a','119-factory-e03-c01-detail-a','119-factory-e06-c05-detail-a','119-factory-e15-c03-detail-a','119-q2factory-e03-c04-title-4','119-factory-e05-c02-detail-a','119-factory-e05-c03-detail-b','119-q2factory-e05-c04-title-0','119-factory-e06-c01-detail-b','119-factory-e08-c06-detail-b','119-factory-e20-c02-summary','119-factory-f06-c02-detail-a','119-factory-e03-c02-detail-a','119-factory-e06-c03-detail-a','119-factory-e06-c04-summary','119-factory-e09-c06-detail-b','119-q2factory-e01-c02-title-1','119-q2factory-e02-c01-title-1','119-factory-e07-c04-summary','119-factory-e02-c02-deep','119-factory-e15-c01-detail-b','119-factory-e16-c03-detail-a','119-factory-e17-c01-detail-b','119-q2factory-e19-c01-title-1','119-q2factory-e22-c01-title-3','119-factory-e05-c01-detail-b','119-q2factory-e07-c05-title-3','119-factory-e08-c01-detail-a','119-factory-e08-c02-detail-a','119-factory-e08-c03-detail-a','119-q2factory-e16-c02-title-2','119-factory-e19-c04-detail-a','119-factory-e08-c04-detail-b','119-q2factory-e08-c05-title-1','119-factory-e09-c08-summary','119-q2factory-e15-c02-title-3','119-q2factory-e19-c05-title-2','119-q2factory-e20-c05-title-2','119-q2factory-e21-c06-title-1','119-q2factory-e21-c07-title-2','119-q2factory-e21-c08-title-1','119-q2factory-e23-c01-title-3','119-q2factory-e23-c03-title-2'].map(id=>V.questionById[id]);
ok(v29Promoted.length===53&&v29Promoted.every(q=>q?.grade==='B'&&q.generatedPractice===false&&q.pageVerified===true&&q.reviewStatus==='source-reviewed'&&q.pastExamClaim!==true),'V45 keeps exactly fifty-three manually source-reviewed promoted questions as B-grade evidence');
ok(V.V29ReviewedPromotions119?.version==='119-v45-reviewed-promotions-v8'&&V.V29ReviewedPromotions119?.promoted?.length===53&&V.V29ReviewedPromotions119?.factoryPromoted===36&&V.V29ReviewedPromotions119?.exactPromoted===17,'V45 promotion registry distinguishes thirty-six factory and seventeen exact-id promotions');
...
ok(['F-SCI-01','F-SCI-04','F-SCI-05','F-SCI-06'].every(id=>fullCoverage.rows.find(x=>x.id===id)?.status==='covered'),'all remaining fire-science rows close only after NFA plus official ScienceAll/KOSHA evidence');
...
ok(fullCoverage.rows.find(x=>x.id==='E-ECG-02')?.status==='covered','non-arrest ECG morphology closes only after direct KHRS AF evidence plus NFA/KACPR rhythm evidence');
ok(fullCoverage.rows.find(x=>x.id==='E-ACLS-02')?.status==='covered','stable/unstable tachycardia and bradycardia algorithm closes on the 2020 KACPR exam-standard algorithm plus NFA hemodynamic assessment');
...
const scienceTailIds=Array.from({length:16},(_,i)=>`119-fireterm-${56+i}`);
ok(scienceTailIds.every(id=>V.questionById[id]?.grade==='P'&&V.QuestionQuality119.isExamStyle(V.questionById[id])),'sixteen atomic gas-law heat-capacity and radiation drills remain P-grade exam-style practice');
ok((V.contentPacks.authored['F03-C03']?.must||[]).some(x=>/분자량/.test(x)&&/원자량/.test(x))&&(V.contentPacks.authored['F03-C03']?.must||[]).some(x=>/PV = nRT/.test(x)),'F-SCI-01/F-SCI-04 expose molecular-mass and ideal-gas definitions');
ok((V.contentPacks.authored['F03-C03']?.calculations||[]).some(x=>/P₁V₁\/T₁ = P₂V₂\/T₂/.test(x.formula||'')),'combined gas law is formula-backed in the lesson');
ok((V.contentPacks.authored['F03-C02']?.calculations||[]).some(x=>/C = m × c/.test(x.formula||''))&&(V.contentPacks.authored['F03-C02']?.calculations||[]).some(x=>/E = φ × ε × σ × T⁴/.test(x.formula||'')),'F-SCI-05/F-SCI-06 expose heat-capacity and radiation calculation contracts');
ok((V.contentPacks.authored['F03-C02']?.officialLinks||[]).some(x=>/408150/.test(x.url||''))&&(V.contentPacks.authored['F03-C03']?.officialLinks||[]).some(x=>/scienceall\.com/.test(x.url||'')),'fire-science supplements are bound to official KOSHA/ScienceAll sources');
...
const acls2Ids=['119-finalgap-acls2-01','119-finalgap-acls2-02','119-finalgap-acls2-03','119-finalgap-acls2-04'];
ok(acls2Ids.every(id=>V.questionById[id]?.grade==='P'&&V.QuestionQuality119.isExamStyle(V.questionById[id])),'four brady/tachy algorithm drills remain P-grade exam-style practice');
ok((V.contentPacks.authored['E11-C02']?.must||[]).some(x=>/빈맥 첫 분기.*혈역학적 안정/.test(x))&&(V.contentPacks.authored['E11-C02']?.must||[]).some(x=>/서맥.*기도.*호흡.*산소.*원인교정/.test(x)),'E-ACLS-02 lesson exposes both tachycardia stability branching and bradycardia ABC sequence');
ok((V.contentPacks.authored['E11-C02']?.must||[]).some(x=>/0\.5~1J\/kg.*2J\/kg/.test(x)),'exam-standard synchronized cardioversion energy sequence is explicit');
const ecg2Ids=['119-finalgap-ecg2-01','119-finalgap-ecg2-02','119-finalgap-ecg2-03','119-finalgap-ecg2-04','119-finalgap-ecg2-05'];
ok(ecg2Ids.every(id=>V.questionById[id]?.grade==='P'&&V.QuestionQuality119.isExamStyle(V.questionById[id])),'five non-arrest ECG morphology drills remain P-grade exam-style practice');
ok((V.contentPacks.authored['E11-C02']?.must||[]).some(x=>/AF.*irregularly irregular.*P파 없음/.test(x)),'AF morphology is directly explicit in the ECG lesson');
ok((V.contentPacks.authored['E11-C02']?.visuals||[]).includes('ems-ecg-nonarrest-rhythms')&&/비심정지 ECG 5리듬/.test(V.Visual119.render('ems-ecg-nonarrest-rhythms')||''),'E11-C02 renders the dedicated five-rhythm non-arrest ECG study visual');
ok(Array.isArray(V.Visual119?.data?.['ems-ecg-nonarrest-rhythms'])&&V.Visual119.data['ems-ecg-nonarrest-rhythms'].length===5,'non-arrest ECG visual exposes exactly five required rhythm groups');
ok((V.contentPacks.authored['E11-C02']?.officialLinks||[]).some(x=>/k-hrs\.org/.test(x.url||'')),'AF morphology is bound to a Korean Heart Rhythm Society guideline source');
...
ok(fullCoverage.rows.find(x=>x.id==='E-ECG-02')?.status==='covered'&&fullCoverage.rows.find(x=>x.id==='E-ACLS-04')?.status==='covered','ECG morphology and named ACLS drug set are both source-closed');
...
const lazyQuestionFiles=['questions-quality2-gap-119.js','questions-verified-ems-batch2-119.js','questions-verified-ems-batch3-119.js','questions-verified-fire-batch2-119.js','questions-verified-ems-breadth1-119.js','questions-verified-ems-breadth2-119.js','questions-verified-fire-breadth2-119.js','questions-verified-highyield4-119.js','questions-verified-fire-target1-119.js','questions-verified-fire-target2-119.js','questions-verified-ems-target1-119.js','questions-verified-ems-target2-119.js','mock-exam-quality-119.js','v29-reviewed-promotions-119.js'];
...
ok(lazyLoader.indexOf("'mock-exam-quality-119.js'")<lazyLoader.indexOf("'v29-reviewed-promotions-119.js'"),'V29 reviewed promotions run after all deferred breadth/target and mock scripts');
...
ok(sourcePdf.includes('preferProxy')&&sourcePdf.includes("origin='official-proxy-fallback'")&&sourcePdf.includes('Math.min(7000,timeoutMs)'),'official PDF viewer abandons a stalled mirror quickly and retries through the dedicated proxy');
...
ok(appSource.includes('scrollTutorToBottom')&&appSource.includes("state().studyTab==='ai'")&&appSource.includes('runtime.tutorForceLatest')&&appSource.includes('x.scrollHeight-x.clientHeight-x.scrollTop<25'),'AI study chat pins latest content while preserving intentional history scroll across AI renders');
...
ok(appSource.includes('study-key-emphasis')&&appSource.includes('detailDefinitionBlock')&&appSource.includes('detailExamPointBlock')&&appSource.includes("return'종류 · 구분'")&&appSource.includes("DETAIL_TYPE_RULES"),'restrained core emphasis and concept-type semantic detail rendering are locked');
ok(appSource.includes('sourceAnchorQueries(c,p)')&&appSource.includes('ConceptArchitecture119?.termsFor')&&appSource.includes('p?.studySchema')&&appSource.includes('V.SourcePDF.locate(key,queries')&&appSource.includes('anchorResult.hits>=2'),'official PDF underline search uses concept architecture, definition/mechanism evidence and full-query page relocation before accepting scored evidence');
...
ok(v9index.includes("updateViaCache:'none'")&&sw.includes("const releaseAsset=/\\.(?:js|css|html|webmanifest)$/i")&&sw.includes("fetch(event.request,{cache:'no-store'})"),'service worker refreshes release assets network-first so stale 30-second/core UI cannot persist after deployment');
