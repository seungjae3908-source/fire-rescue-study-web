...
ok(['E-ECG-01','E-ECG-02','E-ACLS-02','E-ACLS-03'].every(id=>fullCoverage.rows.find(x=>x.id===id)?.status==='partial'),'adjacent ECG brady/tachy and electrical-therapy rows remain fail-closed');
