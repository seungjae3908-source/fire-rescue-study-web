...
ok(v9index.indexOf('./v29-reviewed-promotions-119.js')>v9index.indexOf('./coverage-map-119.js')&&v9index.indexOf('./v29-reviewed-promotions-119.js')<v9index.indexOf('./store.js'),'V29 reviewed promotions apply only after legacy breadth/coverage calculations');
ok(sw.includes("'./v29-reviewed-promotions-119.js'"),'V29 reviewed promotion layer is offline-cached');
