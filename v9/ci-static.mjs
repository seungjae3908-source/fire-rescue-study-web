...
function practiceOrVerifiedPromotion(q){return !!q&&V.QuestionQuality119.isExamStyle(q)&&(q.grade==='P'||(q.grade==='B'&&q.promotedFromGrade==='P'&&q.pageVerified===true&&q.reviewStatus==='manual-reviewed'&&q.pastExamClaim===false&&q.promotionBasis==='2026-NFA-exact-page-manual-review'))}
...
for(const file of [
  ...
  'questions-calculation-119.js','questions-calculation-quality2-119.js','calculation-training-v3-119.js','questions-law-119.js','questions-special-combustible-119.js','questions-ems-gap-practice-119.js','questions-final-gap-119.js','questions-pals-advanced-119.js','questions-fire-terminology-119.js','verified-promotion-fire1-119.js',
...
const promotedFire1=(V.questions||[]).filter(q=>q.promotedFromGrade==='P'&&q.promotionBasis==='2026-NFA-exact-page-manual-review');
ok(V.VerifiedPromotionFire1119?.added===54&&promotedFire1.length===54,'fire promotion batch upgrades fifty-four exact-page manually reviewed questions');
ok(promotedFire1.every(q=>q.grade==='B'&&q.pageVerified===true&&q.reviewStatus==='manual-reviewed'&&q.pastExamClaim===false),'all promoted fire questions stay B-grade page-verified manual reviews without past-exam claims');
...
ok(phaseAFireTermIds.every(id=>practiceOrVerifiedPromotion(V.questionById[id])),'Phase A fire terminology questions remain P-grade practice or explicit exact-page B-grade promotions');
...
ok(['119-fireterm-40','119-fireterm-41','119-fireterm-42','119-fireterm-43'].every(id=>practiceOrVerifiedPromotion(V.questionById[id])),'four kitchen/electrical/gas/metal-fire drills remain practice or explicit exact-page promotions');
...
ok(specialFireIds.every(id=>practiceOrVerifiedPromotion(V.questionById[id])),'eight BLEVE pool jet VCE and explosion-protection drills remain practice or explicit exact-page promotions');
...
ok(scienceTailIds.every(id=>practiceOrVerifiedPromotion(V.questionById[id])),'sixteen atomic gas-law heat-capacity and radiation drills remain practice or explicit exact-page promotions');
...
ok(['119-fireterm-44','119-fireterm-45','119-fireterm-46','119-fireterm-47'].every(id=>practiceOrVerifiedPromotion(V.questionById[id])),'four foam ratio/calculation drills remain practice or explicit exact-page promotions');
