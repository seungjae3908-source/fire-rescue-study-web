...
ok(appSource.includes('scrollTutorToBottom')&&appSource.includes("document.querySelectorAll('.study-ai-chat')")&&appSource.includes('requestAnimationFrame(()=>requestAnimationFrame'),'AI study chat double-frames the visible conversation to the newest answer after DOM replacement');
