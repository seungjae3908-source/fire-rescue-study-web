...
ok(fullCoverage.rows.find(x=>x.id==='E-ACLS-05')?.status==='covered','5H/5T and post-ROSC care close only on current 2025 adult ALS + post-cardiac-arrest guidelines');
