...
ok(appSource.includes('study-key-emphasis')&&appSource.includes('coreHighlightTerms')&&appSource.includes("slice(0,3)"),'core view limits visual emphasis to a few high-yield terms or numeric criteria');
