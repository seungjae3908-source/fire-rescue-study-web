...
try{
  ...
  const bankMs=Date.now()-b0;check(bankMs<1500,'bank opens from prefetched JSON-precomputed core '+bankMs+'ms');
  check(await page.evaluate(()=>window.AITUTOR_V9.Lazy119.contentReady&&window.AITUTOR_V9.Lazy119.questionCoreReady),'bank entry waits only for content plus the precomputed question core');
