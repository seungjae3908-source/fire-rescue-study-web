...
add('F03-C01','fire1',3,7);add('F03-C02','fire1',9,13);add('F03-C03','fire1',14,17);add('F03-C03','fire2',295,328);add('F03-C03','fire1',12,12);add('F03-C03','fire2',191,191);add('F03-C04','fire1',18,21);add('F03-C05','fire1',22,22);add('F03-C06','fire1',23,34);add('F03-C07','fire1',31,34);add('F03-C07','fire2',329,338);add('F03-C08','fire2',339,358);
