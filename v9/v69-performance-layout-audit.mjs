...
ok(runtimeLazy.includes("CONTENT_FILE='content-core-v69.js'")&&runtimeLazy.includes('function prefetch()')&&runtimeLazy.includes('loadScript(QUESTION_CORE_FILE)')&&runtimeAi.includes('/1\\.5B.*Instruct/i')&&runtimeApp.includes('function wantsTutorNumber')&&runtimeApp.includes('scheduleDeferredPrefetch'),'active runtime bundles contain the same V69 prefetch-only lazy-core and AI safeguards');
