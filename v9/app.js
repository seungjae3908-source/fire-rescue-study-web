...
return shell(`<div class="home-grid stats-page screen-scroll"><div class="home-main stats-v61">
...
<section class="card stats-readiness-strip"><div><span>학습 진도</span><b>${r.scopeCoverage}%</b></div><div><span>기억 유지</span><b>${r.retention}%</b></div><div><span>복습 예정</span><b>${r.overdue}</b></div><div><span>최고 시험점수</span><b>${s.bestExam==null?'-':s.bestExam+'점'}</b></div></section>
</div></div>`,'성적·취약점')
}
function resources(){
