...
try{
  ...
  for(const id of targetIds){
    ...
    console.log('V43_BATCH6_SOURCE_REVIEW',JSON.stringify({
    ...
    if(!result.rows.length)throw new Error('V43_BATCH6_SOURCE_PAGE_MISSING '+id);
  }
  await ctx.close();console.log('V43_BATCH6_SOURCE_REVIEW_COMPLETE');
