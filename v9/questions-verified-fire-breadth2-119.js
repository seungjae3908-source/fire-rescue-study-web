...
choices:['초기 화재에서 대류가 발달하며 화염이 벽면에서 천장 방향으로 면이동하는 현상이다','구획실 가연물이 복사열로 거의 동시에 발화하는 현상이다','산소부족 공간에 공기가 유입되어 폭발적으로 연소하는 현상이다','탱크 하부의 물이 급격히 기화해 유류가 분출하는 현상이다'],a:0,
choiceExplanations:['정답. 플레임오버는 초기화재의 대류 발달과 벽면→천장 화염 면이동이 핵심이다.','플래시오버에 가까운 설명이다.','백드래프트에 가까운 설명이다.','보일오버에 가까운 설명이다.']},
