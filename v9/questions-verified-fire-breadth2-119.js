...
q:'플레임오버를 플래시오버와 구분하는 핵심 설명은?',
choices:['산소가 부족한 구획에 공기가 들어와 폭발적으로 연소하는 현상이다','구획실 여러 가연물이 열축적으로 거의 동시에 발화하는 화재전이다','화염이 가연성 물체의 표면을 따라 매우 빠르게 번져 확산되는 현상이다','탱크 하부 수분층의 물이 급격히 기화하며 유류를 대량 분출시키는 현상이다'],a:2,
choiceExplanations:['백드래프트에 가까운 설명이다.','플래시오버에 가까운 설명이다.','정답. 플레임오버의 핵심은 벽·바닥·천장 등 가연성 물체의 표면을 따른 빠른 화염확산이다.','보일오버에 가까운 설명이다.']},

{id:'119-verfirebreadth2-boilover-01',grade:'B',subject:'fire',scopeId:'F03',conceptId:'F03-C12',difficulty:'high',type:'탱크화재형',source:'2026 소방전술1 PDF 319쪽',
q:'보일오버의 발생과정을 가장 적절히 설명한 것은?',
choices:['탱크화재의 열파가 하강해 하부 수분층을 급격히 기화시키며 연소유가 대량 분출한다','연소유 표면에 외부 물이 들어가 표면에서만 넘친다','화재 없이 고온 점성유체와 물 접촉만으로 항상 발생한다','가압 액화가스 용기가 파열하며 급기화한다'],a:0,
choiceExplanations:['정답. 열파 하강과 탱크 하부 수분층의 급격한 기화가 핵심이다.','슬롭오버에 더 가까운 설명이다.','프로스오버와 더 가깝다.','BLEVE와 더 가깝다.']},

{id:'119-verfirebreadth2-slopover-01',grade:'B',subject:'fire',scopeId:'F03',conceptId:'F03-C13',difficulty:'high',type:'탱크화재형',source:'2026 소방전술1 PDF 320쪽',
q:'슬롭오버의 직접적인 계기로 가장 적절한 것은?',
choices:['연소 중인 뜨거운 유류 표면에 물이나 포수용액이 유입되는 것','탱크 하부 수분층까지 열파가 하강하는 것','외부화재로 가압용기가 파열되는 것','산소부족 구획실에 문이 열리는 것'],a:0,
choiceExplanations:['정답. 슬롭오버는 연소유 표면의 외부 물·포수용액 유입이 직접 계기다.','보일오버의 핵심 과정이다.','BLEVE의 과정이다.','백드래프트의 대표 조건이다.']},

{id:'119-verfirebreadth2-frothover-01',grade:'B',subject:'fire',scopeId:'F03',conceptId:'F03-C14',difficulty:'high',type:'특수현상형',source:'2026 소방전술1 PDF 319쪽',
q:'프로스오버를 보일오버와 구분하는 대표 단서는?',
choices:['화재가 없어도 고온 점성유체와 물의 접촉으로 발생할 수 있다','반드시 탱크화재의 열파 하강이 먼저 있어야 한다','반드시 가압용기 파열이 선행되어야 한다','산소부족 공간의 공기유입이 필수다'],a:0,
choiceExplanations:['정답. 프로스오버는 화재 자체가 필수조건이 아니라는 점이 중요한 구분점이다.','보일오버의 조건과 혼동했다.','BLEVE와 혼동한 설명이다.','백드래프트 조건과 다르다.']},
