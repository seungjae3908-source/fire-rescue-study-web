...
},
{
 ...
 choices:['소화용수설비는 필요한 물을 확보·공급하는 기반이고, 소화설비는 그 물이나 약제를 화점에 방출해 소화하는 기능을 가진다','소화용수설비는 화재를 감지하고 경보만 발생시킨다','소화설비는 물을 저장만 하고 방수하지 않는다','두 설비는 기능상 구분할 필요가 없다'],a:0,
 choiceExplanations:['정답. 물을 확보·공급하는 기능과 직접 화점에 방출해 소화하는 기능을 구분하는 것이 핵심이다.','경보설비의 기능과 혼동한 설명이다.','소화설비는 직접 소화작용을 수행한다.','법·교재상 기능별 분류가 구분되어 있다.']
},
{
