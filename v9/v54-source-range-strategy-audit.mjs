...
assert(sw.includes('./v54-responsive.css')&&/ai-tutor-v9-shell-20260924-v(?:54|55|56|57|58|59|60)-/.test(sw),'service worker ships the V54 responsive asset and keeps a V54-or-newer cache generation');
