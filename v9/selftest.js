...
add('현재 커리큘럼 전체 노드',V.curriculum.totalConcepts===V.curriculum.concepts.length,`${V.curriculum.totalConcepts}`);
...
add('현재 커리큘럼 페이지 근거',coverage.verified===V.curriculum.totalConcepts&&coverage.pending===0,`${coverage.verified}/${coverage.total}`);
