...
if(totalVerified!==696)throw new Error('V44_BATCH7_TOTAL_VERIFIED '+totalVerified);
if(under3!==34)throw new Error('V44_BATCH7_UNDER3 '+under3);
if(under4!==122)throw new Error('V44_BATCH7_UNDER4 '+under4);
