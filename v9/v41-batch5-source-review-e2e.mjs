...
try{
  ...
  for(const id of targetIds){
    ...
    console.log('V41_BATCH5_SOURCE_REVIEW',JSON.stringify({
    ...
    if(!result.rows.length)throw new Error('V41_BATCH5_SOURCE_PAGE_MISSING '+id);
  }
  await ctx.close();console.log('V41_BATCH5_SOURCE_REVIEW_COMPLETE');
