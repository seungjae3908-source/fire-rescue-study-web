...
['119-fac-14a','F07-C14','소화용수설비와 직접 소화설비의 구분으로 옳은 것은?',['소화용수설비는 필요한 물을 확보·공급하고 소화설비는 이를 화점에 방출할 수 있다','소화용수설비는 연기만 감지한다','소화설비는 물을 절대 사용하지 않는다','두 분류는 항상 동일하다'],0,'mid','비교형',['정답. 수원확보와 직접방수 기능을 구분한다.','경보설비 설명과 다르다.','수계소화설비가 존재한다.','별도 분류다.']],
