...
['119-h4-3','F05-C05','수용성 제4류 위험물 화재에 사용하는 포소화약제에 대한 설명으로 맞는 것은?',['일반 단백포만 사용해야 한다','내알코올포 등 수용성 위험물용 포를 고려한다','모든 포 사용이 금지된다','금속화재용 분말만 사용한다'],1,'high','적응성형',['수용성 액체에서 포막 안정성 문제가 있을 수 있다.','정답. 공식 공통사항의 핵심이다.','틀리다.','제2·3류 일부 금속성 위험물과 관련된 설명이다.']],
