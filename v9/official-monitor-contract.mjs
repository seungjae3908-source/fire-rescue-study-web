...
assert(client.includes('completeSources=sourceTotal>=4&&sourceOk===sourceTotal')&&client.includes('일부 공식소스 확인 필요')&&client.includes('결과 확정 보류'),'monitor never claims no change while any declared official source is unavailable');
