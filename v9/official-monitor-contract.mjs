...
assert(nfsaMaterials?.urls?.[0]==='https://cherish.nfsa.go.kr/nfsa/releaseinformation/archive/materials/'&&nfsaMaterials?.fallbackUrls?.[0]==='https://cherish.nfsa.go.kr/nfsa/releaseinformation/archive/materials/?pageIdx=1','official textbook monitoring uses the exact NFSA official materials paths');
