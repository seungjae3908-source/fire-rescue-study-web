'use strict';
const CACHE='ai-tutor-v9-shell-20260917-3';
const PREFIX='ai-tutor-v9-';
const CORE=[
  './','./index.html','./styles.css','./manifest.webmanifest','./config.js','./curriculum.js','./content-packs.js','./questions.js','./verified-expansion.js','./verified-completion.js','./verified-final.js','./depth-enrichment.js','./store.js','./mastery.js','./sync-merge.js','./pdf.js','./auth.js','./source-compiler.js','./app.js','./sync-ui.js','./source-ui.js','./selftest.js'
];
