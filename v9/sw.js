'use strict';
const CACHE='ai-tutor-v9-shell-20260926-v69-performance-foundation';
const PREFIX='ai-tutor-v9-';
const CORE=[
  './','./index.html','./styles.css','./v54-responsive.css','./manifest.webmanifest',
  './boot-v69-1.js','./boot-v69-2.js','./boot-v69-3a.js','./boot-v69-3b.js','./boot-v69-4.js','./boot-v69-5a.js','./boot-v69-5b.js','./boot-v69-6.js','./boot-v69-7a.js','./boot-v69-7b.js','./boot-v69-8.js'
]
/* V69 bundled source trace only; these names are maintained inside boot bundles and are not install-precache entries.
'./config.js'
'./curriculum.js'
