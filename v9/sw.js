...
const CORE=[
  './','./index.html','./styles.css','./manifest.webmanifest','./config.js','./curriculum.js','./curriculum-complete-2026.js','./content-packs.js','./questions.js','./verified-expansion.js','./verified-completion.js','./verified-final.js','./questions-scope-2026.js','./depth-enrichment.js','./depth-enrichment-2.js','./content-rich-2026.js','./ems-rich-2026.js','./store.js','./mastery.js','./sync-merge.js','./pdf.js','./source-pdf.js','./supabase-lite.js','./auth.js','./auth-membership-guard.js','./source-compiler.js','./app.js','./sync-ui.js','./source-ui.js','./selftest.js'
];
