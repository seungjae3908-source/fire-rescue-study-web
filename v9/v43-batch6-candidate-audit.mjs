...
for(const[id,qid]of Object.entries(promotedExpected)){
  ...
  if(verified.length!==3)throw new Error('V43_BATCH6_VERIFIED_COUNT '+id+' '+verified.length);
...
if(totalVerified!==690)throw new Error('V43_BATCH6_TOTAL_VERIFIED '+totalVerified);
if(under3!==40)throw new Error('V43_BATCH6_UNDER3 '+under3);
if(under4!==122)throw new Error('V43_BATCH6_UNDER4 '+under4);
