...
const topics=[
  ...
  T('F-SCI-02','fire','소방과학','화학결합·화학반응식·산화환원','partial',['F03-C03'],{calc:true}),
  ...
  T('F-BLD-02','fire','건축화재·방재','방화구획·방화벽·방화문','partial',['F07-C01'],{recent:'2026'}),
  T('F-BLD-03','fire','건축화재·방재','불연·준불연·난연재료·내화구조','partial',['F07-C01'],{recent:'2026'}),
