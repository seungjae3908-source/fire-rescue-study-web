...
const topics=[
  ...
  T('F-COMB-02','fire','연소이론','이론산소량·이론공기량·연소반응식 계산','partial',['F03-C03'],{calc:true}),
  ...
  T('F-COMB-06','fire','연소이론','최소산소농도(MOC)','partial',['F04-C06'],{calc:true,recent:'2026'}),
  ...
  T('F-FIRE-03','fire','화재이론','중성대·압력차·개구부 영향','partial',['F03-C07'],{recent:'2026'}),
