...
const topics=[
  ...
  T('F-SCI-01','fire','소방과학','원자·분자·원자량·분자량','missing',[],{calc:true}),
  T('F-SCI-02','fire','소방과학','화학결합·화학반응식·산화환원','missing',[],{calc:true}),
  T('F-SCI-03','fire','소방과학','물질상태·상변화·감열·잠열','partial',['F03-C02'],{calc:true}),
  T('F-SCI-04','fire','소방과학','기체법칙·이상기체·mol','missing',[],{calc:true,recent:'2026'}),
  ...
  T('F-COMB-02','fire','연소이론','이론산소량·이론공기량·연소반응식 계산','missing',[],{calc:true}),
  T('F-COMB-03','fire','연소이론','인화점·연소점·발화점','partial',['F03-C03']),
  T('F-COMB-04','fire','연소이론','자연발화·축열·최소점화에너지','partial',['F03-C03']),
  T('F-COMB-05','fire','연소이론','연소하한·상한·폭발범위·온도/압력 영향','partial',['F03-C03'],{calc:true}),
  T('F-COMB-06','fire','연소이론','최소산소농도(MOC)','missing',[],{calc:true,recent:'2026'}),
  ...
  T('F-FIRE-03','fire','화재이론','중성대·압력차·개구부 영향','missing',[],{recent:'2026'}),
  T('F-FIRE-04','fire','화재이론','연료지배·환기지배·Flow Path','partial',['F03-C05','F03-C07']),
  T('F-FIRE-05','fire','화재이론','연기층·플룸·천장제트·가시거리','partial',['F03-C07']),
  ...
  T('F-HAZ-04','fire','위험물','특수가연물','missing',[]),
  ...
  T('E-LAW-01','ems','법령','119구조·구급법·시행령','missing',[],{recent:'2025'}),
  ...
  T('E-RESP-01','ems','기도·호흡','호흡곤란·천식·COPD·흡입손상','partial',['E10-C01','E10-C02','E10-C03','E10-C04','E10-C05']),
  ...
  T('E-INF-01','ems','내과응급','패혈증·감염성 응급','missing',[]),
  ...
  T('E-PALS-01','ems','소아소생','전문소아소생술·소아 서맥/빈맥/쇼크','missing',[],{visual:true}),
  T('E-NRP-01','ems','신생아','신생아소생술 초기평가·환기·압박','missing',[],{visual:true}),
