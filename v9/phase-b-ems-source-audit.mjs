...
const targets=[
  ...
  {id:'E-MCI-02-COMMAND',title:'재난 지휘체계',terms:['사고관리체계','현장지휘','현장 지휘','지휘체계','지휘 체계','현장통제','현장 통제','지휘소']},
  {id:'E-MCI-02-COMMS',title:'재난 통신',terms:['커뮤니케이션 시스템','무선통신','무선 통신','통신체계','통신 체계','통신망','통신']},
  {id:'E-MCI-02-SPECIAL',title:'특수재난',terms:['특수재난','특수 재난','위험물사고','위험물 사고','화학사고','화학 사고','방사선','방사능','생물학적','화생방']},
  ...
  {id:'E-CALC-01-O2',title:'산소통 사용시간',terms:['산소통 사용시간','산소통사용시간','실린더 상수','실린더상수','잔압','산소용기 사용시간','산소통','산소 용기','산소용기','용기 압력','용기압력','압력게이지','압력 게이지','산소 유량','산소유량','유량계','잔여 산소','남은 산소']},
  {id:'E-CALC-02-IV',title:'수액 적하속도',terms:['적하속도','적하 속도','gtt/min','gtt','drop factor','분당 방울','시간당 주입량','수액세트','수액 세트','점적','점적수','방울수','방울 수','주입속도','주입 속도','수액 주입','수액주입','mL/hr','ml/hr','mL/h']},
  ...
  {id:'E-GEN-QUALITY',title:'응급의료 교육·질관리',terms:['질관리','질 관리','품질관리','교육 및 훈련','교육훈련','지속교육','계속교육']},
  {id:'E-GEN-PRO',title:'응급구조사 역할·책임·전문성 유지',terms:['전문성','역할과 책임','역할 및 책임','윤리','책임','계속교육','보수교육']},
  {id:'E-TRN-AMB',title:'구급차 운용·관리',terms:['구급차 운용','구급차운용','구급차 관리','구급차관리','구급차','차량 점검','차량점검']},
  {id:'E-TRN-AIR',title:'항공이송',terms:['항공이송','항공 이송','헬기이송','헬기 이송','항공구급','항공 구급']},
  {id:'E-ACLS-ROSC',title:'소생 후 치료',terms:['소생후 치료','소생 후 치료','자발순환회복','자발 순환 회복','ROSC','체온관리']},
  {id:'E-ACLS-SPECIAL',title:'특수상황 심정지',terms:['특수상황 심정지','저체온 심정지','익수 심정지','감전 심정지','낙뢰','임신 중 심정지','외상성 심정지','아나필락시스 심정지']},
  {id:'E-NEURO-STROKE',title:'허혈성 뇌졸중',terms:['허혈성 뇌졸중','허혈성뇌졸중','뇌졸중','FAST','뇌경색']},
  {id:'E-GU-01',title:'비뇨생식기계 응급',terms:['급성 콩팥손상','급성 신손상','신부전','콩팥손상','요로결석','신장결석','혈뇨','비뇨생식']},
  {id:'E-HEMA-01',title:'조혈계 응급',terms:['조혈계','빈혈','백혈병','혈소판','혈우병','겸상적혈구','조혈 장애','조혈장애']},
  {id:'E-ENT-01',title:'눈·귀·코·목 응급',terms:['눈 응급','안구','눈 손상','귀 응급','비출혈','코피','이물질','인후','후두']},
  {id:'E-MSK-MED-01',title:'비외상성 근골격계 응급',terms:['비외상성 근골격','퇴행성 관절','관절염','통풍','만성 통증','근골격계 질환']},
  {id:'E-GI-HEPATO',title:'간·담도·췌장 응급',terms:['간질환','간 질환','담낭','담도','췌장염','췌장','간경변']},
  {id:'E-MCI-TRANSPORT',title:'대량환자 분산이송',terms:['분산 이송','분산이송','대량환자 이송','다수사상자 이송','이송 우선순위']}
];
