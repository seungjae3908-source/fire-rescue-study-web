...
},
{
 ...
 choices:['ABC와 쇼크 징후를 먼저 보고 OPQRST·SAMPLE로 병력을 수집하며 통증 부위를 불필요하게 반복 압박하지 않는다','통증 위치·양상만으로 원인질환을 현장에서 확정한다','병력·활력징후 없이 복부를 깊게 반복 촉진해 판단한다','ABC보다 음식·배변 여부를 먼저 보고 전신평가는 미룬다'],a:0,
