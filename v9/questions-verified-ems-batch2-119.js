...
},
{
 ...
 choices:['ABC와 쇼크 징후를 먼저 보고 OPQRST·SAMPLE로 병력을 수집하며 통증 부위를 불필요하게 반복 압박하지 않는다','통증 위치 하나만으로 현장에서 질환을 확정진단한다','복부를 처음부터 강하게 반복 촉진한다','ABC 평가보다 음식 섭취 여부만 먼저 확인한다'],a:0,
...
},
{
 ...
 choices:['노출물질·시간·양·노출기간·이미 시행한 처치·환자 체중','환자 이름 글자 수와 신발 색만','체중 없이 물질 이름 하나만','노출경로와 시간을 모두 생략한다'],a:0,
 choiceExplanations:['정답. 중독평가에서는 물질, 시간, 양, 노출기간, 시행처치, 체중 등 구체적인 노출정보를 확인한다.','중독의 위험도와 처치를 판단하는 정보가 아니다.','용량과 환자 체중 등 추가 정보가 중요하다.','노출경로와 시점은 중독평가의 중요한 정보다.']
},
{
