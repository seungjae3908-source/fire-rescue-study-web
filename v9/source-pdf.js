...
V.SourcePDF={attach,get,has,remove,render,sourcePage:key=>SOURCE_PAGES[key]||'',privacy:{localOnly:true,serverUpload:false,originalUnmodified:true},runtime:'pdfjs-text-coordinate-overlay'};
})();