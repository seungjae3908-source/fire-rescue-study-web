...
},
{
 ...
 choices:['계단·좁은 공간·척추손상 가능성·환자 체중과 상태를 고려해 장비를 선택하고 잠금·고정을 확인한다','현장·손상기전과 무관하게 가장 익숙한 하나의 들것만 사용한다','환자를 고정했으면 잠금장치 상태는 별도로 확인하지 않는다','장비는 맞게 고르되 이동 방향과 시점은 각 대원이 개별 판단한다'],a:0,
...
},
{
 ...
 choices:['주호소를 확인하고 OPQRST·SAMPLE로 병력을 수집하며 관련 계통검진과 활력징후를 연결한다','주호소와 무관하게 같은 신체부위만 반복 검사한다','병력은 확인하지만 활력징후는 측정하지 않는다','현장에서는 주호소만 확인하고 병력수집은 이송 후로 미룬다'],a:0,
