...
},
{
 ...
 choices:['계단·좁은 공간·척추손상 가능성·환자 체중과 상태를 고려해 장비를 선택하고 잠금·고정을 확인한다','환자의 손상기전과 현장 구조가 달라도 가장 익숙한 하나의 들것을 모든 상황에 동일하게 사용한다','환자를 장비에 올린 뒤에는 체중분산과 안전띠만 확인하고 잠금장치 상태는 별도로 확인하지 않는다','장비 종류는 상황에 맞게 고르되 이동 시작시점과 방향은 팀원 각자가 판단해 개별적으로 움직인다'],a:0,
...
},
{
 ...
 choices:['주호소를 확인하고 OPQRST·SAMPLE로 병력을 수집하며 관련 계통검진과 활력징후를 연결한다','주호소가 달라도 모든 비외상 환자에게 동일한 신체부위만 반복 검사하고 관련 계통검진은 생략한다','병력과 주호소는 현장에서 확인하지만 활력징후는 증상과 직접 관련이 없으므로 측정하지 않는다','현장에서는 주호소만 확인하고 OPQRST·SAMPLE 병력수집은 병원 도착 후 의료진에게 모두 맡긴다'],a:0,
