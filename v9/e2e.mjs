...
try{
  ...
  const bodyOverflow=await p.locator('.study-body').evaluate(el=>el.scrollWidth<=el.clientWidth+1);assert(bodyOverflow,'desktop study body has no horizontal overflow');
