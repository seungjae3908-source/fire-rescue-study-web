...
try{
  ...
  await p.evaluate(()=>window.AITUTOR_V9.Lazy119.ensureQuestions());
  ...
  assert(lazyAfter.ready&&lazyAfter.count>=3000&&lazyAfter.hasDeferred&&lazyAfter.mock,'question lane loads the full bank and mock engine on demand');
