...
const checks={
  ...
  runtimePerformanceBudgetContract:workflow.includes('Static runtime performance budget gate')&&performanceBudget.includes('PERFORMANCE_BUDGET_COMPLETE')&&performanceBudget.includes("version:'119-performance-budget-v5-json-precomputed'")&&performanceBudget.includes('totalBytes:850000'),
