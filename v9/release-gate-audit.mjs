...
const files=[
  ...
  'questions-suppression-depth-119.js','questions-governance-depth-119.js','questions-investigation-depth-119.js','questions-facilities-depth-119.js',
  ...
  'ems-rich-2026.js','ems-depth-119.js','ems-visuals-119.js','question-bank-119.js','textbook-grounded-119.js',
  'visual-completion-119.js','calculation-contract-119.js'
];
...
const checks={
  ...
  questionContract:qa.examStyle===1056&&qa.duplicateTexts.length===0,
  realMockFailClosed:mock.ready===false&&mock.missingFireScopes.includes('F05')&&mock.missingFireScopes.includes('F06')&&mock.missingFireScopes.includes('F07'),
